...
export async function getServerSideProps(context) {
  ...
  const data = await singleCategory(params.slug);
  if (data && data.error) {
    console.log(data.error);
  } else {
    return {
      props: { category: data.category, blogs: data.blogs, params },
    };
  }
}
